...
if (is_home()) {
    ...
    $keywords = "TIM,ANDROID,HTML5,CCS3,JS,BLOG";
} else {
...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/tomorrow.css" />
<script>if(self!=top){top.location=self.location}</script>

<script>var duoshuoQuery={short_name:'timding66666'}</script>
